    ...
    public class DlibFaceLandmarkDetectorSetupToolsWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            using (new EditorGUI.DisabledScope(false))
            {
                ...
                EditorGUILayout.LabelField("[Setup for OpenCV Example Scenes]", customStyle);
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    {
                        DlibFaceLandmarkDetectorProjectSizeReducerWindow.OpenProjectSizeReducerWindow();
                    }
                }
                GUILayout.EndVertical();
                ...
                EditorGUI.BeginDisabledGroup(DlibFaceLandmarkDetectorMenuItem.ValidateUseWasm2023Support());
#endif
                GUILayout.BeginVertical("box");
                {
                ...
                GUILayout.BeginVertical("box");
                {
                    if (DlibFaceLandmarkDetectorMenuItem.ValidateUseWasm2023Support())
                    {
#if UNITY_2023_3_OR_NEWER
                        string aboutText = "PlayerSettings.WebGL.wasm2023 : " + DlibFaceLandmarkDetectorMenuItem.ValidateUseWasm2023Support();
                        EditorGUILayout.LabelField(aboutText, EditorStyles.wordWrappedLabel);
#else
                        ...
                        {
                            DlibFaceLandmarkDetectorMenuItem.UseWebGLWasm2023Support(false);
                        }
                    }
                    else
                    {
                        ...
                        {
                            DlibFaceLandmarkDetectorMenuItem.UseWebGLWasm2023Support(true);
                        }
                    }
                }
                GUILayout.EndVertical();
