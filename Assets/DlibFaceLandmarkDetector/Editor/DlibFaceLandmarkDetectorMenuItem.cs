...
namespace DlibFaceLandmarkDetector.Editor
{
    ...
    {
        // Constants
        private static readonly string SYMBOL_DLIB_DONT_USE_UNSAFE_CODE = "DLIB_DONT_USE_UNSAFE_CODE";
        ...
        public static void SetPluginImportSettings()
        {
            try
            {
                ...
                _pluginFileIndex = 0;
                _pluginFileCount = GetPluginFileCount(pluginsFolderPath);

                //Android
                SetAndroidPluginImportSettings(pluginsFolderPath, true);

                //iOS
                SetIOSPluginImportSettings(pluginsFolderPath, true);

                //VisionOS
                SetVisionOSPluginImportSettings(pluginsFolderPath, true);

                //OSX
                SetOSXPluginImportSettings(pluginsFolderPath, true);

                //Windows
                SetWindowsPluginImportSettings(pluginsFolderPath, true);

                //Linux
                SetLinuxPluginImportSettings(pluginsFolderPath, true);

                //UWP
                SetUWPPluginImportSettings(pluginsFolderPath, true);

                //WebGL
                SetWebGLPluginImportSettings(pluginsFolderPath, true);
            }
            catch (Exception e)
            {
        ...
        public static void SetAndroidPluginImportSettings(string pluginsFolderPath, bool displayProgressBar = false)
        {
    ...
    new Dictionary<BuildTarget, Dictionary<string, string>>() { {BuildTarget.Android,new Dictionary<string, string> () { {
        ...
        public static void SetIOSPluginImportSettings(string pluginsFolderPath, bool displayProgressBar = false, bool incrementalBuild = false)
        {
        ...
        public static void SetVisionOSPluginImportSettings(string pluginsFolderPath, bool displayProgressBar = false)
        {
        ...
        public static void SetOSXPluginImportSettings(string pluginsFolderPath, bool displayProgressBar = false)
        {
    ...
    new Dictionary<BuildTarget, Dictionary<string, string>>() {
        ...
        public static void SetWindowsPluginImportSettings(string pluginsFolderPath, bool displayProgressBar = false)
        {
    ...
    new Dictionary<BuildTarget, Dictionary<string, string>>() { {BuildTarget.StandaloneWindows,new Dictionary<string, string> () { {
        ...
        public static void SetLinuxPluginImportSettings(string pluginsFolderPath, bool displayProgressBar = false)
        {
    ...
    new Dictionary<BuildTarget, Dictionary<string, string>>() { {BuildTarget.StandaloneLinux64,new Dictionary<string, string> () { {
        ...
        public static void SetUWPPluginImportSettings(string pluginsFolderPath, bool displayProgressBar = false)
        {
        ...
        public static void SetWebGLPluginImportSettings(string pluginsFolderPath, bool displayProgressBar = false)
        {
            ...
            if (threads && simd)
            {
                SetPlugins(new string[] { WebGLPluginFilePath("dlibfacelandmarkdetector_simd_threads.a") }, null, new Dictionary<BuildTarget, Dictionary<string, string>>() { {
                                            BuildTarget.WebGL,
                                            null
                                        }
                                    }, displayProgressBar);
            ...
            {
                SetPlugins(new string[] { WebGLPluginFilePath("dlibfacelandmarkdetector_threads.a") }, null, new Dictionary<BuildTarget, Dictionary<string, string>>() { {
                                            BuildTarget.WebGL,
                                            null
                                        }
                                    }, displayProgressBar);
            ...
            {
                SetPlugins(new string[] { WebGLPluginFilePath("dlibfacelandmarkdetector_simd.a") }, null, new Dictionary<BuildTarget, Dictionary<string, string>>() { {
                                            BuildTarget.WebGL,
                                            null
                                        }
                                    }, displayProgressBar);
            ...
            {
                SetPlugins(new string[] { WebGLPluginFilePath("dlibfacelandmarkdetector.a") }, null, new Dictionary<BuildTarget, Dictionary<string, string>>() { {
                                            BuildTarget.WebGL,
                                            null
                                        }
                                    }, displayProgressBar);
...
#if (UNITY_2022_3_OR_NEWER && !(UNITY_2023_1_OR_NEWER) && !(UNITY_2022_3_0 || UNITY_2022_3_1 || UNITY_2022_3_2 || UNITY_2022_3_3 || UNITY_2022_3_4 || UNITY_2022_3_5 || UNITY_2022_3_6 || UNITY_2022_3_7 || UNITY_2022_3_8 || UNITY_2022_3_9 || UNITY_2022_3_10 || UNITY_2022_3_11 || UNITY_2022_3_12 || UNITY_2022_3_13 || UNITY_2022_3_14 || UNITY_2022_3_15 || UNITY_2022_3_16 || UNITY_2022_3_17)) || UNITY_6000_0_OR_NEWER
                    Symbol.Add(NamedBuildTarget.VisionOS, Symbol.GetCurrentSymbols(NamedBuildTarget.VisionOS), SYMBOL_DLIB_DONT_USE_UNSAFE_CODE);
#endif
...
#if (UNITY_2022_3_OR_NEWER && !(UNITY_2023_1_OR_NEWER) && !(UNITY_2022_3_0 || UNITY_2022_3_1 || UNITY_2022_3_2 || UNITY_2022_3_3 || UNITY_2022_3_4 || UNITY_2022_3_5 || UNITY_2022_3_6 || UNITY_2022_3_7 || UNITY_2022_3_8 || UNITY_2022_3_9 || UNITY_2022_3_10 || UNITY_2022_3_11 || UNITY_2022_3_12 || UNITY_2022_3_13 || UNITY_2022_3_14 || UNITY_2022_3_15 || UNITY_2022_3_16 || UNITY_2022_3_17)) || UNITY_6000_0_OR_NEWER
                    Symbol.Remove(NamedBuildTarget.VisionOS, Symbol.GetCurrentSymbols(NamedBuildTarget.VisionOS), SYMBOL_DLIB_DONT_USE_UNSAFE_CODE);
#endif
